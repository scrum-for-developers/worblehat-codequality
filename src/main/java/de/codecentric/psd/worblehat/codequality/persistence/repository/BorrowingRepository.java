...
public class BorrowingRepository {
    ...
    public List<Borrowing> findAllBorrowings() {
        ...
        borrowings.add(new Borrowing(book1, "borrower1@example.foo", DateTime.now().minusDays(60)));

        Book book2 = new Book("Harry Potter and the Prisoner of Azkaban", "J. K. Rowling.", "", "0747542155", 1999);
        borrowings.add(new Borrowing(book2, "borrower2@example.foo", DateTime.now().minusDays(30)));
        ...
        borrowings.add(new Borrowing(book4, "borrower4@example.foo", DateTime.now().minusDays(45)));
