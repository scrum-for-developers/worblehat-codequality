...
public class BorrowingRepository {
    ...
    public List<Borrowing> findAllBorrowings() {
        ...
        borrowings.add(new Borrowing(book2, "borrower2@example.foo", DateTime.now().minusDays(15)));
        ...
        borrowings.add(new Borrowing(book4, "borrower4@example.foo", DateTime.now().minusDays(60)));
